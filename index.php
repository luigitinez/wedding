...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark navbar-fixed-top">
	  <a class="navbar-brand" href="#">Charlotte & Jose's Wedding</a>
		...
		<div id="rsvp" class="tap">
			...
			<div class="row contacto">
				...
				<div class="col-md-6">
					...
					<div class="contact-box">
						<ins>Charlotte</ins>
						<br><em>Movil:</em> <strong><a href="tel:+34646321122">+34 646 921 122 </a></strong> <br>
						<em>Correo :</em>  <strong><a href="mailto:charlotte.w.91@hotmail.com?Subject=Boda">charlotte.w.91@hotmail.com</a></strong><br>
					</div>
					<div class="contact-box">
						<ins>Jose</ins><br>
						<em>Movil:</em><strong><a href="tel:+34679789367">+34 679 789 367</a></strong><br> 
						<em>Correo: </em> <strong> <a href="mailto:jo_se_ma@hotmail.com?Subject=Boda">jo_se_ma@hotmail.com </a> </strong><br>
					</div>
			...
			<div class=" form col-md-12">
				<form name="formulario" id="formulario">
					<div class="form-group">
			    		...
			    		<button type="submit" class="btn btn-info" id="enviar" style="color: white">Send</button> 
			    	</div>
			    </form>
				
				<span class="error" style="display:none">Error</span>
				<span class="success" style="display:none"> Success / Éxito</span>
			</div>
		</div>
...
<script type="text/javascript">//Scroll boton hacia arriba
